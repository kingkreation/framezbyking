...
const styles = StyleSheet.create({
  ...
  preview: { width: '100%', height: 220, borderRadius: 8, marginTop: 12, backgroundColor: '#f2f2f2' },
  row: { flexDirection: 'row', gap: 12, marginTop: 16 },
  button: { flex: 1, backgroundColor: '#000', padding: 14, borderRadius: 8, alignItems: 'center' },
  buttonText: { color: '#fff', fontWeight: '700' },
  secondary: { backgroundColor: '#eee' },
  buttonSecondaryText: { color: '#000', fontWeight: '700' },
});